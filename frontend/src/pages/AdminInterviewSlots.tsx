...
export function AdminInterviewSlots() {
  ...
  const statusBadge = (status: string) => {
    ...
    return <span className="text-xs font-medium text-gray-500 bg-gray-100 px-2 py-0.5 rounded-full">Cancelado</span>;
  };
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Crea horarios disponibles para que los adoptantes agenden su entrevista.</p>
        </div>
      ...
      {slots.length === 0 ? (
        ...
        <div className="space-y-2">
          {slots.map((slot) => (
            <div key={slot.id} className="flex items-center justify-between bg-white border border-gray-200 rounded-lg px-4 py-3">
